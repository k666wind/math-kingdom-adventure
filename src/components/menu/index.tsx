...
export const MainMenu: React.FC = () => {
  ...
  const navCards = [
    ...
    { emoji:'🎯', label:'Daily Challenges', screen:'daily_challenges'    as const, badge:true },
    ...
    <div className="h-full flex flex-col overflow-hidden" style={{background:'#FFF8F0'}}>
      ...
      <div className="flex-1 scroll-y px-4 py-4">
        ...
        <div className="rounded-xl p-3 mb-4 flex items-center gap-3"
          ...
          <div>
            <div className="font-fredoka text-sm" style={{color:'#2D1B69'}}>Keep your streak going!</div>
